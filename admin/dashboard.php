...
.stat-users .stat-icon { color: #3498db; }

.stat-books::before { background: #2ecc71; }
.stat-books .stat-icon { color: #2ecc71; }
...
/* ===== ACHIEVEMENT LIST (for sidebar items) ===== */
.achievement-list {
    display: flex;
    flex-direction: column;
    gap: 6px;
